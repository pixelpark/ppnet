...
gulp.task('build_copy', function() {
  ...
  gulp.src(['./app/redirect.html', 'app/config.xml', 'app/config.json', './app/config.js'])
    .pipe(gulp.dest('./www/'));
...
gulp.task('build2', ['clean', 'bower', 'build_styles', 'build_scripts', 'build_images', 'build_copy']);

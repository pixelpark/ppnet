! function t(e, i, n) {
  ...
  3: [
    function(t, e) {
      ...
      var i = t("./src/geocoder_control"),
        n = t("./src/grid_control"),
        o = t("./src/feature_layer"),
        s = t("./src/legend_control"),
        r = t("./src/share_control"),
        a = t("./src/tile_layer"),
        l = t("./src/info_control"),
        h = t("./src/map"),
        u = t("./src/grid_layer");
      L.mapbox = e.exports = {
  ...
  4: [
    function(t, e) {
      function i(t, e, i) {
        ...
        var a;
        if (!i || "object" != typeof window.XDomainRequest && "function" != typeof window.XDomainRequest) a = new window.XMLHttpRequest;
        else {
      ...
      (function() {
        function t(e, i) {
          function n(t) {
            ...
            if ("bug-string-char-index" == t) e = "a" != "a" [0];
              ...
              if ("json-stringify" == t) {
                var l = i.stringify,
                  u = "function" == typeof l && y;
                if (u) {
                  (s = function() {
                    return 1
                  }).toJSON = s;
                  try {
                    u = "0" === l(0) && "0" === l(new o) && '""' == l(new r) && l(v) === _ && l(_) === _ && l() === _ && "1" === l(s) && "[1]" == l([s]) && "[null]" == l([_]) && "null" == l(null) && "[null,null,null]" == l([_, v, null]) && l({
                      a: [s, !0, !1, null, "\x00\b\n\f\r	"]
          ...
          var o = e.Number || a.Number,
            ...
            l = e.Object || a.Object,
            h = e.Date || a.Date,
            u = e.SyntaxError || a.SyntaxError,
            c = e.TypeError || a.TypeError,
            p = e.Math || a.Math,
            d = e.JSON || a.JSON;
          "object" == typeof d && d && (i.stringify = d.stringify, i.parse = d.parse);
          var m, f, _, g = l.prototype,
            v = g.toString,
          ...
          if (!n("json")) {
            ...
            if (!y) var M = p.floor,
            D = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], S = function(t, e) {
              return D[e] + 365 * (t - 1970) + M((t - 1969 + (e = +(e > 1))) / 4) - M((t - 1901 + e) / 100) + M((t - 1601 + e) / 400)
            };
            if ((m = g.hasOwnProperty) || (m = function(t) {
              var e, i = {};
              return (i.__proto__ = null, i.__proto__ = {
                toString: 1
              }, i).toString != v ? m = function(t) {
                var e = this.__proto__,
                  i = t in (this.__proto__ = null, this);
                return this.__proto__ = e, i
              } : (e = i.constructor, m = function(t) {
                var i = (this.constructor || e).prototype;
                return t in this && !(t in i && this[t] === i[t])
              }), i = null, m.call(this, t)
            }), f = function(t, e) {
              var i, n, o, r = 0;
              (i = function() {
                this.valueOf = 0
              }).prototype.valueOf = 0, n = new i;
              for (o in n) m.call(n, o) && r++;
              return i = n = null, r ? f = 2 == r ? function(t, e) {
                var i, n = {}, o = v.call(t) == b;
                for (i in t) o && "prototype" == i || m.call(n, i) || !(n[i] = 1) || !m.call(t, i) || e(i)
              } : function(t, e) {
                var i, n, o = v.call(t) == b;
                for (i in t) o && "prototype" == i || !m.call(t, i) || (n = "constructor" === i) || e(i);
                (n || m.call(t, i = "constructor")) && e(i)
              } : (n = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"], f = function(t, e) {
                var i, o, r = v.call(t) == b,
                  a = !r && "function" != typeof t.constructor && s[typeof t.hasOwnProperty] && t.hasOwnProperty || m;
                for (i in t) r && "prototype" == i || !a.call(t, i) || e(i);
              ...
              var k = {
                ...
                I = function(t) {
                  for (var e = '"', i = 0, n = t.length, o = !C || n > 10, s = o && (C ? t.split("") : t); n > i; i++) {
                  ...
                  return e + '"'
                }, R = function(t, e, i, n, o, s, r) {
                  var a, l, h, u, p, d, g, y, L, b, C, D, k, A, O, z;
                  try {
                    a = e[t]
                  } catch (B) {}
                  if ("object" == typeof a && a)
                    if (l = v.call(a), l != T || m.call(a, "toJSON")) "function" == typeof a.toJSON && (l != P && l != E && l != x || m.call(a, "toJSON")) && (a = a.toJSON(t));
                    else
                  if (a > -1 / 0 && 1 / 0 > a) {
                    if (S) {
                      for (p = M(a / 864e5), h = M(p / 365.2425) + 1970 - 1; S(h + 1, 0) <= p; h++);
                      for (u = M((p - S(h, 0)) / 30.42); S(h, u + 1) <= p; u++);
                      p = 1 + p - S(h, u), d = (a % 864e5 + 864e5) % 864e5, g = M(d / 36e5) % 24, y = M(d / 6e4) % 60, L = M(d / 1e3) % 60, b = d % 1e3
                    } else h = a.getUTCFullYear(), u = a.getUTCMonth(), p = a.getUTCDate(), g = a.getUTCHours(), y = a.getUTCMinutes(), L = a.getUTCSeconds(), b = a.getUTCMilliseconds();
                    a = (0 >= h || h >= 1e4 ? (0 > h ? "-" : "+") + U(6, 0 > h ? -h : h) : U(4, h)) + "-" + U(2, u + 1) + "-" + U(2, p) + "T" + U(2, g) + ":" + U(2, y) + ":" + U(2, L) + "." + U(3, b) + "Z"
                  } else a = null; if (i && (a = i.call(e, t, a)), null === a) return "null";
                  if (l = v.call(a), l == w) return "" + a;
                  if (l == P) return a > -1 / 0 && 1 / 0 > a ? "" + a : "null";
                  if (l == E) return I("" + a);
                  if ("object" == typeof a) {
                    for (A = r.length; A--;)
                      if (r[A] === a) throw c();
                    if (r.push(a), C = [], O = s, s += o, l == x) {
                      for (k = 0, A = a.length; A > k; k++) D = R(k, a, i, n, o, s, r), C.push(D === _ ? "null" : D);
                      z = C.length ? o ? "[\n" + s + C.join(",\n" + s) + "\n" + O + "]" : "[" + C.join(",") + "]" : "[]"
                    } else f(n || a, function(t) {
                      var e = R(t, a, i, n, o, s, r);
                      e !== _ && C.push(I(t) + ":" + (o ? " " : "") + e)
                    }), z = C.length ? o ? "{\n" + s + C.join(",\n" + s) + "\n" + O + "}" : "{" + C.join(",") + "}" : "{}";
                    return r.pop(), z
                  }
              ...
              i.stringify = function(t, e, i) {
                ...
                if (a == x) {
                  r = {};
                  for (var l, h = 0, u = e.length; u > h; l = e[h++], a = v.call(l), (a == E || a == P) && (r[l] = 1));
                }
                if (i)
                  if ((a = v.call(i)) == P) {
                    if ((i -= i % 1) > 0)
                      for (n = "", i > 10 && (i = 10); n.length < i; n += " ");
                  } else a == E && (n = i.length <= 10 ? i : i.slice(0, 10));
                return R("", (l = {}, l[""] = t, l), o, r, n, "", [])
              }
            }
            if (!n("json-parse")) {
              var z, B, N = r.fromCharCode,
                H = {
                  92: "\\",
                  34: '"',
                  47: "/",
                  ...
                  for (var t, e, i, n, o, s = B, r = s.length; r > z;) switch (o = s.charCodeAt(z)) {
                    case 9:
                    case 10:
                    case 13:
                    case 32:
                    ...
                    case 58:
                    case 44:
                      return t = C ? s.charAt(z) : s[z], z++, t;
                    case 34:
                      for (t = "@", z++; r > z;)
                        if (o = s.charCodeAt(z), 32 > o) j();
                        else
                      if (92 == o) switch (o = s.charCodeAt(++z)) {
                        case 92:
                        case 34:
                        case 47:
                        case 98:
                        ...
                        case 114:
                          ...
                          break;
                        case 117:
                          for (e = ++z, i = z + 4; i > z; z++) o = s.charCodeAt(z), o >= 48 && 57 >= o || o >= 97 && 102 >= o || o >= 65 && 70 >= o || j();
                          t += N("0x" + s.slice(e, z));
                          break;
                        default:
                          j()
                        ...
                        if (34 == o) break;
                        for (o = s.charCodeAt(z), e = z; o >= 32 && 92 != o && 34 != o;) o = s.charCodeAt(++z);
                        t += s.slice(e, z)
                      } if (34 == s.charCodeAt(z)) return z++, t;
                      j();
                    default:
                      if (e = z, 45 == o && (n = !0, o = s.charCodeAt(++z)), o >= 48 && 57 >= o) {
                        for (48 == o && (o = s.charCodeAt(z + 1), o >= 48 && 57 >= o) && j(), n = !1; r > z && (o = s.charCodeAt(z), o >= 48 && 57 >= o); z++);
                        if (46 == s.charCodeAt(z)) {
                          for (i = ++z; r > i && (o = s.charCodeAt(i), o >= 48 && 57 >= o); i++);
                          i == z && j(), z = i
                        }
                        if (o = s.charCodeAt(z), 101 == o || 69 == o) {
                          for (o = s.charCodeAt(++z), (43 == o || 45 == o) && z++, i = z; r > i && (o = s.charCodeAt(i), o >= 48 && 57 >= o); i++);
                          i == z && j(), z = i
                        }
                        return +s.slice(e, z)
                      }
                      if (n && j(), "true" == s.slice(z, z + 4)) return z += 4, !0;
                      if ("false" == s.slice(z, z + 5)) return z += 5, !1;
                      if ("null" == s.slice(z, z + 4)) return z += 4, null;
                      j()
                  }
                  return "$"
                }, F = function(t) {
                  ...
                  if ("$" == t && j(), "string" == typeof t) {
                    ...
                    if ("[" == t) {
                      for (e = []; t = Z(), "]" != t; i || (i = !0)) i && ("," == t ? (t = Z(), "]" == t && j()) : j()), "," == t && j(), e.push(F(t));
                      return e
                    }
                    if ("{" == t) {
                      for (e = {}; t = Z(), "}" != t; i || (i = !0)) i && ("," == t ? (t = Z(), "}" == t && j()) : j()), ("," == t || "string" != typeof t || "@" != (C ? t.charAt(0) : t[0]) || ":" != Z()) && j(), e[t.slice(1)] = F(Z());
                      return e
                    }
                    j()
                  }
              ...
              i.parse = function(t, e) {
                var i, n;
                return z = 0, B = "" + t, i = F(Z()), "$" != Z() && j(), z = B = null, e && v.call(e) == b ? W((n = {}, n[""] = i, n), "", e) : i
              }
            }
          }
        ...
        var o = "function" == typeof define && define.amd,
          s = {
            "function": !0,
            object: !0
          }, r = s[typeof i] && i && !i.nodeType && i,
          a = s[typeof window] && window || this,
          l = r && s[typeof e] && e && !e.nodeType && "object" == typeof n && n;
        if (!l || l.global !== l && l.window !== l && l.self !== l || (a = l), r && !o) t(a, r);
        else {
          var h = a.JSON,
            u = a.JSON3,
            c = !1,
            p = t(a, a.JSON3 = {
              noConflict: function() {
                return c || (c = !0, a.JSON = h, a.JSON3 = u, h = u = null), p
              }
            });
          a.JSON = {
            parse: p.parse,
      ...
      ! function(t, i, n) {
        ...
        function() {
          ...
          s.Util.requestAnimFrame = function(e, n, r, a) {
            return e = s.bind(e, n), r && o === i ? (e(), void 0) : o.call(t, e, a)
        ...
        s.Mixin = {}, s.Mixin.Events = {
          addEventListener: function(t, e, i) {
            ...
            var n, o, a, l, h, u, c, p = this[r] = this[r] || {}, d = i && i !== this && s.stamp(i);
            for (t = s.Util.splitWords(t), n = 0, o = t.length; o > n; n++) a = {
              action: e,
              context: i || this
            }, l = t[n], d ? (h = l + "_idx", u = h + "_len", c = p[h] = p[h] || {}, c[d] || (c[d] = [], p[u] = (p[u] || 0) + 1), c[d].push(a)) : (p[l] = p[l] || [], p[l].push(a));
            return this
          },
          ...
          removeEventListener: function(t, e, i) {
            ...
            for (t = s.Util.splitWords(t), n = 0, o = t.length; o > n; n++)
              ...
              } else delete m[a], delete m[u], delete m[c];
            return this
          },
          ...
          fireEvent: function(t, e) {
            ...
            var i, n, o, a, l, h = s.Util.extend({}, e, {
                type: t,
                target: this
              }),
              u = this[r];
          ...
          getViewportOffset: function(t) {
            ...
            do {
              ...
              if ("relative" === e && !r.offsetLeft) {
                var h = s.DomUtil.getStyle(r, "width"),
                  u = s.DomUtil.getStyle(r, "max-width"),
                  c = r.getBoundingClientRect();
                ("none" !== h || "none" !== u) && (o += c.left + r.clientLeft), n += c.top + (a.scrollTop || l.scrollTop || 0);
                break
              }
              r = r.offsetParent
            } while (r);
        ...
        function() {
          ...
          fitBounds: function(t, e) {
            ...
            var i = s.point(e.paddingTopLeft || e.padding || [0, 0]),
              ...
              h = this.unproject(a.add(l).divideBy(2).add(r), o);
          ...
          getBoundsZoom: function(t, e, i) {
            ...
            var n, o = this.getMinZoom() - (e ? 1 : 0),
              ...
              u = !0;
            i = s.point(i || [0, 0]);
            do o++, n = this.project(h, o).subtract(this.project(l, o)).add(i), u = e ? n.x < a.x || n.y < a.y : a.contains(n); while (u && r >= o);
          ...
          _resetView: function(t, e, i, n) {
            ...
            var r = !this._loaded;
            this._loaded = !0, r && (this.fire("load"), this.eachLayer(this._layerAdd, this)), this.fire("viewreset", {
              hard: !i
          ...
          unproject: function(t) {
            for (var e, i = s.LatLng.RAD_TO_DEG, n = this.R_MAJOR, o = this.R_MINOR, r = t.x * i / n, a = o / n, l = Math.sqrt(1 - a * a), h = Math.exp(-t.y / n), u = Math.PI / 2 - 2 * Math.atan(h), c = 15, p = 1e-7, d = c, m = .1; Math.abs(m) > p && --d > 0;) e = l * Math.sin(u), m = Math.PI / 2 - 2 * Math.atan(h * Math.pow((1 - e) / (1 + e), .5 * l)) - u, u += m;
          ...
          _initIcon: function() {
            ...
            r && h.markerPane.appendChild(this._icon), a && l && h.shadowPane.appendChild(this._shadow)
          },
          ...
          _adjustPan: function() {
            if (this.options.autoPan) {
              ...
              var o = t.layerPointToContainerPoint(n),
                ...
                u = 0,
                c = 0;
              o.x + i + l.x > h.x && (u = o.x + i - h.x + l.x), o.x - u - a.x < 0 && (u = o.x - a.x), o.y + e + l.y > h.y && (c = o.y + e - h.y + l.y), o.y - c - a.y < 0 && (c = o.y - a.y), (u || c) && t.fire("autopanstart").panBy([u, c])
            }
          },
          ...
          _sqClosestPointOnSegment: function(t, e, i, n) {
            var o, r = e.x,
              ...
              h = i.y - a,
              u = l * l + h * h;
            return u > 0 && (o = ((t.x - r) * l + (t.y - a) * h) / u, o > 1 ? (r = i.x, a = i.y) : o > 0 && (r += l * o, a += h * o)), l = t.x - r, h = t.y - a, n ? l * l + h * h : new s.Point(r, a)
          }
          ...
          var i, n, o, r, a, l, h, u, c, p = [1, 4, 2, 8],
            d = s.LineUtil;
          for (n = 0, h = t.length; h > n; n++) t[n]._code = d._getBitCode(t[n], e);
          for (r = 0; 4 > r; r++) {
            for (u = p[r], i = [], n = 0, h = t.length, o = h - 1; h > n; o = n++) a = t[n], l = t[o], a._code & u ? l._code & u || (c = d._getEdgeIntersection(l, a, u, e), c._code = d._getBitCode(c, e), i.push(c)) : (l._code & u && (c = d._getEdgeIntersection(l, a, u, e), c._code = d._getBitCode(c, e), i.push(c)), i.push(a));
            t = i
          }
          return t
        ...
        function() {
          ...
          _containsPoint: function(t, e) {
            var i, n, o, r, a, l, h, u = this.options.weight / 2;
            for (s.Browser.touch && (u += 10), i = 0, r = this._parts.length; r > i; i++)
          ...
          _containsPoint: function(t) {
            var e, i, n, o, r, a, l, h, u = !1;
            if (s.Polyline.prototype._containsPoint.call(this, t, !0)) return !0;
            for (o = 0, l = this._parts.length; l > o; o++)
              for (e = this._parts[o], r = 0, h = e.length, a = h - 1; h > r; a = r++) i = e[r], n = e[a], i.y > t.y != n.y > t.y && t.x < (n.x - i.x) * (t.y - i.y) / (n.y - i.y) + i.x && (u = !u);
            return u
          }
          ...
          geometryToLayer: function(t, e, i, n) {
            var o, r, a, l, h = "Feature" === t.type ? t.geometry : t,
              u = h.coordinates,
              c = [];
            switch (i = i || this.coordsToLatLng, h.type) {
              ...
              case "MultiPoint":
                for (a = 0, l = u.length; l > a; a++) o = i(u[a]), c.push(e ? e(t, o) : new s.Marker(o));
              ...
              case "GeometryCollection":
                for (a = 0, l = h.geometries.length; l > a; a++) c.push(this.geometryToLayer({
        ...
        function() {
          ...
          addDoubleTapListener: function(t, e, n) {
            ...
            return t.addEventListener(p, o, !1), f.addEventListener(d, r, !1), s.Browser.pointer && f.addEventListener(s.DomEvent.POINTER_CANCEL, r, !1), this
          },
          ...
          _animateZoom: function(t, e, i, n, o, r) {
    ...
    function(t, e, i) {
      ! function(t, e) {
        ...
        function h(e, i, o, s) {
          ...
          for (var a, l, u, c = "", p = 0, d = e.length; d > p; ++p) switch (a = e[p], l = a[1], a[0]) {
            case "#":
              if (u = o.lookup(l), "object" == typeof u || "string" == typeof u)
                if (T(u))
                  for (var m = 0, f = u.length; f > m; ++m) c += h(a[4], i, o.push(u[m]), s);
                else u && (c += h(a[4], i, o.push(u), s));
                else
              if (n(u)) {
                var _ = null == s ? null : s.slice(a[3], a[5]);
                u = u.call(o.view, _, r), null != u && (c += u)
              } else u && (c += h(a[4], i, o, s));
              break;
            case "^":
              u = o.lookup(l), (!u || T(u) && 0 === u.length) && (c += h(a[4], i, o, s));
              break;
            case ">":
        ...
        function d(e, n) {
          ...
          for (var a, l, h, d, _, L, b = p(n), T = new r(e), P = [], E = [], x = [], w = !1, C = !1; !T.eos();) {
            if (a = T.pos, h = T.scanUntil(b[0]))
              for (var M = 0, D = h.length; D > M; ++M) d = h.charAt(M), i(d) ? x.push(E.length) : C = !0, E.push(["text", d, a, a + 1]), a += 1, "\n" == d && s();
            if (!T.scan(b[0])) break;
            ...
            if (_ = [l, h, a, T.pos], E.push(_), "#" === l || "^" === l) P.push(_);
            else if ("/" === l) {
              if (L = P.pop(), !L) throw new Error('Unopened section "' + h + '" at ' + a);
              if (L[1] !== h) throw new Error('Unclosed section "' + L[1] + '" at ' + a)
            } else if ("name" === l || "{" === l || "&" === l) C = !0;
            else if ("=" === l) {
              if (n = h.split(f), 2 !== n.length) throw new Error("Invalid tags at " + a + ": " + n.join(", "));
              b = p(n)
            }
          }
    ...
    function(t, e) {
      var i = function() {
        ...
        function e(t, e, s, r, a, h, u) {
          var c = new l(n(t, m), n(e, m), i(s), r > 0 ? r.toString() : null, n(a, f), null, i(u));
      ...
      var o = function(t) {
            ...
            for (var r, a, l, h = n, c = i.length; c > h;) {
              ...
              switch (p) {
                case "&":
                  ...
                  break;
                case "</":
                  (r = /^([-\w:]+)[^\'\"]*/.exec(_)) ? r[0].length === _.length && ">" === i[h + 1] ? (h += 2, l = r[1].toLowerCase(), e.endTag && e.endTag(l, s, V, u(e, i, h, o, s))) : h = d(i, h, e, s, V, o) : e.pcdata && e.pcdata("&lt;/", s, V, u(e, i, h, o, s));
                  break;
                case "<":
                  if (r = /^([-\w:]+)\s*\/?/.exec(_))
                    if (r[0].length === _.length && ">" === i[h + 1]) {
                      h += 2, l = r[1].toLowerCase(), e.startTag && e.startTag(l, [], s, V, u(e, i, h, o, s));
                      var g = t.ELEMENTS[l];
                      if (g & q) {
                        var v = {
                          name: l,
                  ...
                  if (!o.noMoreEndComments) {
                    ...
                    if (c > a) {
                      if (e.comment) {
                        ...
                        e.comment(y.substr(0, y.length - 2), s, V, u(e, i, a + 1, o, s))
                      }
                      h = a + 1
        ...
        function f(e, i, n, o, s, r) {
          ...
          if (i.eflags & t.eflags.CDATA) n.cdata && n.cdata(d, o, s, u(n, e, p, r, o));
          else {
            ...
            startTag: function(o, s, a) {
              if (!n && t.ELEMENTS.hasOwnProperty(o)) {
                ...
                if (!(l & t.eflags.FOLDABLE)) {
                  ...
                  a.push(">"), l & t.eflags.EMPTY && !(u & t.eflags.EMPTY) && a.push("</", c, ">")
                }
              }
            },
            endTag: function(e, o) {
        ...
        function E(e, i, n, o, s) {
          for (var r = 0; r < i.length; r += 2) {
            var a, l = i[r],
              ...
              u = h,
              c = null;
            if (a = e + "::" + l, (t.ATTRIBS.hasOwnProperty(a) || (a = "*::" + l, t.ATTRIBS.hasOwnProperty(a))) && (c = t.ATTRIBS[a]), null !== c) switch (c) {
              case t.atype.NONE:
                break;
              case t.atype.SCRIPT:
        ...
        var k = {
          ...
          $ = {};
        return $.escapeAttrib = $.escapeAttrib = r, $.makeHtmlSanitizer = $.makeHtmlSanitizer = v, $.makeSaxParser = $.makeSaxParser = l, $.makeTagPolicy = $.makeTagPolicy = x, $.normalizeRCData = $.normalizeRCData = a, $.sanitize = $.sanitize = C, $.sanitizeAttribs = $.sanitizeAttribs = E, $.sanitizeWithPolicy = $.sanitizeWithPolicy = w, $.unescapeEntities = $.unescapeEntities = s, $
      }(n),
        s = o.sanitize;
  ...
  11: [
    function(t, e) {
      "use strict";
      e.exports = {
        HTTP_URLS: ["http://a.tiles.mapbox.com/v3/", "http://b.tiles.mapbox.com/v3/"],
        FORCE_HTTPS: !1,
        HTTPS_URLS: ["https://a.tiles.mapbox.com/v3/", "https://b.tiles.mapbox.com/v3/"]
      }
    }, {}
  ],
  12: [
        ...
        a = L.FeatureGroup.extend({
          ...
          _initialize: function(t) {
            ...
            if (n)
              ...
              "setStyle" in o && o.setStyle(r.style(t)), o.feature = t, a && o.bindPopup(a, {
                closeButton: !1
              }), this.addLayer(o)
            }
          }
    ...
    function(t, e) {
      ...
      e.exports = function(t) {
        ...
        return s.getURL = function() {
          ...
          if (!s.getURL()) throw new Error("Geocoding map ID not set");
          if ("string" != typeof t) {
          ...
          return i.strict(e, "function"), o(s.queryURL(t), function(t, n) {
            if (n && (n.length || n.results)) {
              var o = {
                results: n.length ? n : n.results
              };
              n.results && (o.latlng = [n.results[0][0].lat, n.results[0][0].lon]), n.results && void 0 !== n.results[0][0].bounds && (o.bounds = n.results[0][0].bounds, o.lbounds = i.lbounds(o.bounds)), e(null, o)
            } else e(t || !0)
          }), s
          ...
          _geocode: function(t) {
            ...
            var e = this._map,
              i = L.bind(function(t, e) {
                if (L.DomUtil.removeClass(this._container, "searching"), !t && e && e.results && e.results.length) {
                  if (this._results.innerHTML = "", 1 === e.results.length) this.fire("autoselect", {
                    data: e
                  }), n(e.results[0][0]), this._closeIfOpen();
                  else {
                    for (var i = 0, o = Math.min(e.results.length, 5); o > i; i++) {
                      for (var s = [], r = 0; r < e.results[i].length; r++) e.results[i][r].name && s.push(e.results[i][r].name);
                      if (s.length) {
                        var a = L.DomUtil.create("a", "", this._results);
                        a.innerHTML = s.join(", "), a.href = "#", L.bind(function(t) {
                          L.DomEvent.addListener(a, "click", function(e) {
                            n(t[0]), L.DomEvent.stop(e), this.fire("select", {
                              data: t
                            })
                          }, this)
                        }, this)(e.results[i])
                    ...
                    if (e.results.length > 5) {
                      ...
                      l.innerHTML = "Top 5 of " + e.results.length + "  results"
                    }
                  }
                  this.fire("found", e)
              ...
              n = L.bind(function(t) {
                ...
                } else void 0 !== t.lat && void 0 !== t.lon && this._map.setView([t.lat, t.lon], void 0 === e.getZoom() ? this.options.pointZoom : Math.max(e.getZoom(), this.options.pointZoom))
              }, this);
            this.geocoder.query(this._input.value, i)
          }
        });
      e.exports.GeocoderControl = n, e.exports.geocoderControl = function(t, e) {
        return new n(t, e)
      }
    }, {
      "./geocoder": 13
        ...
        s = L.Class.extend({
          ...
          _update: function() {
            if (this.active()) {
              ...
              if (!(e > this.options.maxZoom || e < this.options.minZoom))
                for (var n = new L.Point(Math.floor(t.min.x / i), Math.floor(t.min.y / i)), o = new L.Point(Math.floor(t.max.x / i), Math.floor(t.max.y / i)), s = this._map.options.crs.scale(e) / i, r = n.x; r <= o.x; r++)
                  for (var a = n.y; a <= o.y; a++) {
                    var l = (r + s) % s,
                      h = (a + s) % s;
                    this._getTile(e, l, h)
                  }
          ...
          _getTile: function(t, e, i, s) {
            ...
            if (a.z = t, this._tileShouldBeLoaded(a)) {
              if (r in this._cache) {
                if (!s) return;
                return "function" == typeof this._cache[r] ? s(this._cache[r]) : this._cache[r].push(s), void 0
              }
  ...
  21: [
    function(t, e) {
      "use strict";
      var i = (t("./util"), t("./tile_layer").tileLayer),
        n = t("./feature_layer").featureLayer,
        o = t("./grid_layer").gridLayer,
        s = t("./grid_control").gridControl,
        r = t("./info_control").infoControl,
        a = t("./share_control").shareControl,
        l = t("./legend_control").legendControl,
        h = L.Map.extend({
      ...
      e.exports.Map = h, e.exports.map = function(t, e, i) {
        return new h(t, e, i)
      }
    }, {
      "./feature_layer": 12,
        ...
        n = L.Control.extend({
          ...
          _shareClick: function(t) {
            ...
            var e = this._tilejson || this._map._tilejson || {}, i = encodeURIComponent(this.options.url || e.webpage || window.location),
              ...
              s = this._url.base() + e.id + ".html?secure",
              r = "//twitter.com/intent/tweet?status=" + n + " " + i,
              a = "//www.facebook.com/sharer.php?u=" + i + "&t=" + encodeURIComponent(e.name),
              l = "//www.pinterest.com/pin/create/button/?url=" + i + "&media=" + o + "&description=" + e.name,
              h = "<h3>Share this map</h3><div class='mapbox-share-buttons'><a class='mapbox-button mapbox-button-icon mapbox-icon-facebook' target='_blank' href='{{facebook}}'>Facebook</a><a class='mapbox-button mapbox-button-icon mapbox-icon-twitter' target='_blank' href='{{twitter}}'>Twitter</a><a class='mapbox-button mapbox-button-icon mapbox-icon-pinterest' target='_blank' href='{{pinterest}}'>Pinterest</a></div>".replace("{{twitter}}", r).replace("{{facebook}}", a).replace("{{pinterest}}", l),
              u = '<iframe width="100%" height="500px" frameBorder="0" src="{{embed}}"></iframe>'.replace("{{embed}}", s),
              c = "Copy and paste this <strong>HTML code</strong> into documents to embed this map on web pages.";
            L.DomUtil.addClass(this._modal, "active"), this._sharing = L.DomUtil.create("div", "mapbox-modal-body", this._content), this._sharing.innerHTML = h;
            var p = L.DomUtil.create("input", "mapbox-embed", this._sharing);
            p.type = "text", p.value = u;
  ...
  27: [
    function(t, e) {
      ...
      e.exports = {
        ...
        base: function() {
          return (this.isSSL() ? i.HTTPS_URLS : i.HTTP_URLS)[0]
        },
